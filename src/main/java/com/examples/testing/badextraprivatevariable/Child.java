...
@Correct(name = "Bad Extra Private Variable", version = "2023.10.0", author = "challen@illinois.edu")
public class Child extends Parent {
  ...
  private static List<String> checkFeatures(Features solution, Features submission) {
    ...
    int submissionVariableCount = submission.getFeatureMap().getOrDefault(FeatureName.CLASS_FIELD, 0);
